...
# Versions of fabric known not to work with this release of telarana-network
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run -v $PWD:/tmp/telarana-network --rm hyperledger/fabric-tools:$IMAGETAG rm -Rf /tmp/telarana-network/ledgers-backup
